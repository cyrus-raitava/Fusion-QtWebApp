...
#include "../Fusion-QtWebApp/QtWebApp/qtwebsockets/src/websockets/qsslserver_p.h"
...
void QSslServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QSslServer::preSharedKeyAuthenticationRequired)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject QSslServer::staticMetaObject = {
    { &QTcpServer::staticMetaObject, qt_meta_stringdata_QSslServer.data,
      qt_meta_data_QSslServer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
