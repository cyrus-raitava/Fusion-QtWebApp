...
#include "../Fusion-QtWebApp/QtWebApp/qtwebsockets/src/websockets/qwebsocketserver.h"
...
void QWebSocketServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QWebSocketServer::preSharedKeyAuthenticationRequired)) {
                *result = 6;
                return;
            }
        }
...
const QMetaObject QWebSocketServer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QWebSocketServer.data,
      qt_meta_data_QWebSocketServer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
